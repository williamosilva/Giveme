...
const StyledButton = ({ onClick, children }) => {
    ...
    return (_jsxs("button", { className: `
        ...
        overflow-hidden
      `, onClick: handleClick, children: [_jsx("span", { className: "relative z-10 transition-all duration-300 ease-in-out", children: isCopied ? "Copied!" : children }), _jsx("span", { className: `
          absolute 
          inset-0 
          border-[2px] 
          border-white 
